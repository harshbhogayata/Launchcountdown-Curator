...
export function StorePrivacy() {
  useStorePageMeta({
    ...
    description: `How The Curator collects, uses, and deletes your data — aligned with App Store App Privacy, Google Play Data safety, and Samsung Galaxy Store requirements.`,
  });
      ...
      <div className="space-y-5">
        <StoreDocBlock title="What we collect">
          ...
          <ul className="list-disc space-y-2 pl-5">
            ...
            <li><strong style={{ color: LP.onSurface }}>Subscription status</strong> — tier and entitlement state from RevenueCat (App Store, Google Play, or Galaxy Store handles payment details; we do not store card numbers).</li>
        ...
        <StoreDocBlock title="What we do not do">
          ...
          <p>App Store App Privacy labels, Google Play Data safety, and Samsung Galaxy Store privacy declarations reflect this.</p>
        </StoreDocBlock>
        ...
        <StoreDocBlock title="How we use data">
          <ul className="list-disc space-y-2 pl-5">
            ...
            <li>Process subscriptions and restore purchases (RevenueCat + App Store / Google Play / Galaxy Store).</li>
